...
volatile u32 TransferEnd = 0, DMAEndOfTransfer = 0;
...
//u8 sdio_get_state(u32 flag)
//{
//	u8 state;
//	if(__SDIO_GET_FLAG(SDIO, flag)){
//	
//	}
//	return state;
//}

//void sdio_clear_flag(u32 sdio_flg)
//{
//	__SDIO_CLEAR_FLAG(SDIO, sdio_flg);
//}

//u32 sdio_read_data(void)
//{
//	u32 data;
